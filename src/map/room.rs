...
pub fn d66_room(roll: u8) -> RoomShape {
    match roll {
        ...
        13 => RoomShape {
            width: 4, height: 4,
            doors: vec![
                DoorPosition { side: DoorSide::West, offset: 2 },
                DoorPosition { side: DoorSide::South, offset: 2 },
            ],
        },
        14 => RoomShape {
            width: 3, height: 5,
        ...
        32 => RoomShape {
            ...
            doors: vec![
                DoorPosition { side: DoorSide::North, offset: 2 },
                DoorPosition { side: DoorSide::South, offset: 3 },
                DoorPosition { side: DoorSide::West, offset: 1 },
                DoorPosition { side: DoorSide::East, offset: 2 },
            ],
        },
        ...
        36 => RoomShape {
            ...
            doors: vec![
                DoorPosition { side: DoorSide::North, offset: 1 },
                DoorPosition { side: DoorSide::South, offset: 2 },
                DoorPosition { side: DoorSide::East, offset: 3 },
            ],
        },
        // --- Row 4: rolls 41-46 ---
        41 => RoomShape {
        ...
        66 => RoomShape {
            ...
            doors: vec![
                DoorPosition { side: DoorSide::North, offset: 2 },
                DoorPosition { side: DoorSide::South, offset: 3 },
                DoorPosition { side: DoorSide::East, offset: 4 },
                DoorPosition { side: DoorSide::West, offset: 2 },
            ],
        },
        _ => unreachable!(),
