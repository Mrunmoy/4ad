...
class TestCleric:
    ...
    def test_cleric_stats_at_level_1(self):
        """Cleric at level 1: Attack 3, Defense 4, Life 5."""
        cleric = Cleric("Elena")
        assert cleric.attack == 3
        assert cleric.defense == 4
        assert cleric.life == 5
...
class TestRogue:
    ...
    def test_rogue_stats_at_level_1(self):
        """Rogue at level 1: Attack 3, Defense 4, Life 4."""
        rogue = Rogue("Shadow")
...
class TestElf:
    ...
    def test_elf_stats_at_level_1(self):
        """Elf at level 1: Attack 3, Defense 4, Life 4."""
        elf = Elf("Legolas")
        assert elf.attack == 3
...
class TestDwarf:
    ...
    def test_dwarf_stats_at_level_1(self):
        """Dwarf at level 1: Attack 4, Defense 5, Life 7."""
        dwarf = Dwarf("Gimli")
